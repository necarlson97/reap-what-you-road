...
var steps: Array = [
	...
	"Important:\n'yellow' drivers/cars are just knocked out. You need them red - dead.",
	"Their starting color tells you a bit more about them:\nteal are fast, purple are drunk ordistracted.",
	"You'll figure it out.",
	"Don't hesitate to space you town out - really let the cars get up to speed.",
